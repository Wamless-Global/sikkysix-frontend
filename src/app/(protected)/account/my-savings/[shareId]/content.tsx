...
export default function PortfolioItemDetailPageContent() {
	...
	const handleWithdrawClick = async () => {
		...
		try {
			...
			logger.log('Withdrawal preview data:', data);
			setPreviewData(data);
	...
	return (
		<div className="max-w-2xl">
				...
				<DialogContent className="sm:max-w-md mt-10 p-7">
					...
					{previewData && (
						<div className="space-y-4">
							...
							{previewData.is_early_withdrawal && previewData.penalty?.type_applied && (
			...
			<ConfirmationModal
				...
				description={
					previewData?.is_early_withdrawal && previewData.penalty?.type_applied
						? `Are you sure you want to withdraw early? You will receive ${formatBaseurrency(previewData.estimated_net_amount_to_user, 2, false)} after penalties.`
						: `Are you ready to withdraw? You will receive ${formatBaseurrency(previewData?.estimated_net_amount_to_user || 0, 2, false)}.`
				}
