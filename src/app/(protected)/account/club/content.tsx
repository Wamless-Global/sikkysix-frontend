...
import { generateSlug, getCategoryButtonText, getCategoryDisplayStatus, handleFetchMessage } from '@/lib/helpers';
...
export default function ClubsContent() {
	...
	return (
		<div className="space-y-6">
			<p className="account-page-title mt-0 mb-4 !text-xm">Clubs</p>
