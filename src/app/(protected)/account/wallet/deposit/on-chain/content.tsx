			...
			<Card className="bg-background border-0 shadow-none">
				<CardHeader>
					<CardTitle className="sub-page-heading">
						Deposit {getBaseCurrency()} {amount ? `(${amount} NGN)` : ''}
					</CardTitle>
						...
						<Accordion type="single" collapsible className="w-full pt-2">
							<AccordionItem value="notice" className="border-b-0">
								...
								<AccordionContent className="text-sm text-muted-foreground pt-2 pb-0 text-left">
									Please ensure you are sending {getBaseCurrency()} on the {MOCK_NETWORK} network. Sending any other asset or using a different network may result in the permanent loss of your funds. Transactions typically confirm within a few minutes.
								</AccordionContent>
							</AccordionItem>
						</Accordion>
					</div>
