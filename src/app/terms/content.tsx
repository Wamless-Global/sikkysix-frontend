	...
	return (
		<div className="bg-background text-foreground font-sans flex flex-col min-h-screen">
			...
			<section className="container mx-auto px-4 py-16 md:py-24 max-w-4xl flex-1">
				...
				<p className="mb-4 sm:text-lg text-muted-foreground text-center">Welcome to our service. Please read these terms and conditions carefully before using our application.</p>
