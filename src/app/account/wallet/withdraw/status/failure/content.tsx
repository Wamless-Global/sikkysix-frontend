...
export default function FailureStatusContent() {
			...
			<Card className="bg-background border-0 shadow-none">
				...
				<CardContent className="space-y-6 pt-6 px-0">
					<Alert variant="destructive">
						...
						<AlertDescription>We couldn&apos;t process your withdrawal request. Please try again or contact support if the problem persists.</AlertDescription>
					</Alert>
