		...
		<div className="max-w-lg mx-auto space-y-8 py-10">
			<Card className="bg-background border-0 shadow-none">
				<CardHeader className="px-0 text-center items-center">
					<Clock4 className="h-16 w-16 text-yellow-500 mb-4 animate-pulse" />
					<CardTitle className="sub-page-heading text-2xl">Withdrawal Pending</CardTitle>
					<CardDescription className="sub-page-heading-sub-text pt-1">
						Your withdrawal of {amount || 'N/A'} {selectedAsset?.symbol || assetId || ''} is currently processing. This may take a few minutes.
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-6 pt-6 px-0">
					...
					<div className="flex flex-col sm:flex-row gap-3 mt-8">
						<Button onClick={() => router.push('/account/wallet/transactions')} variant="outline" size="lg" className="w-full border-border">
							View Transactions
						</Button>
