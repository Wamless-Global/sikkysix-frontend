...
import { getAccountStatusBadgeVariant } from '@/lib/helpers';
...
export default function UserReportPageContent() {
				...
				<Card className="lg:col-span-1">
					...
					<CardContent className="space-y-3">
						...
						<div className="flex justify-between items-center">
							...
							<Badge variant={getAccountStatusBadgeVariant(accountInfo.status)} className="text-xs">
