				...
				{referralsData.map((referral) => (
					<div key={referral.id} className="flex items-center justify-between px-1 py-3 rounded-lg border border-border/20">
						<div className="flex items-center space-x-3">
							{referral.avatar && referral.avatar !== '/user-avatar-placeholder.png' ? <Image src={referral.avatar} alt={referral.name} className="h-8 w-8 rounded-full object-cover" /> : <UserCircle className="h-8 w-8 text-muted-foreground" />}
							<div>
