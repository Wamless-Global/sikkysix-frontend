...
import { ShowWhenNotInTelegram } from '../providers/ShowWhenNotInTelegram';
			...
			<header className="container mx-auto px-4 py-0 sm-py-2 flex justify-between items-center relative">
				...
				{mobileMenuOpen && (
					<div className="fixed inset-0 z-50 flex md:hidden">
						...
						<div className="relative flex flex-col w-64 h-full bg-background shadow-xl z-10 text-sm">
							...
							<div className="p-4 mt-auto">
								{isTelegram ? (
									...
									<CustomLink href="/auth/login" passHref>
										<Button variant={'success'} size={'sm'} className="w-full" onClick={() => setMobileMenuOpen(false)}>
											My Account
										</Button>
									</CustomLink>
								)}
