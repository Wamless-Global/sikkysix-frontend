...
import { LayoutDashboard, Users, FolderKanban, ArrowLeftRight, Settings, MessageSquare, BarChart, UserCheck, FileText, WalletIcon, Trophy, ClipboardList, ListChecks } from 'lucide-react';
