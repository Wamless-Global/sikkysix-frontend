...
const UserHeader: React.FC<UserHeaderProps> = ({ onMenuToggle, notifications }) => {
	return (
		<header className="z-40 flex h-20 items-center justify-between border-b border-border/40 bg-[var(--dashboard-secondary)] px-4 text-gray-900 md:px-6 lg:hidden w-full sticky top-0 left-0 right-0">
