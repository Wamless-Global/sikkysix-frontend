...
export interface AuthContextType {
	...
	signup: (name: string, email: string, confirmEmail: string, password: string, confirmPassword: string, country: string, phone_number: string, referralId?: string, roles?: Array<string>) => Promise<void>;
